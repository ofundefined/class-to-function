...
function writeFile(filePath, codeInput, shouldOverWrite) {
    return __awaiter(this, void 0, void 0, function () {
        var lintedCodeInput, actualFilePath;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, lintFixText(codeInput)];
                case 1:
                    lintedCodeInput = _a.sent();
                    actualFilePath = shouldOverWrite ? filePath : "".concat(filePath, ".tmp.tsx");
                    fs.writeFile(actualFilePath, lintedCodeInput, "utf8", function (err) {
                        return __awaiter(this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
